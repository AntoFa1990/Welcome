...
```
cd existing_repo
git remote add origin https://ucb.bootcampcontent.com/UCB-Coding-Bootcamp/UCB-VIRT-DATA-PT-11-2022-U-LOLC.git
git branch -M main
...
- [ ] [Set up project integrations](https://ucb.bootcampcontent.com/UCB-Coding-Bootcamp/UCB-VIRT-DATA-PT-11-2022-U-LOLC/-/settings/integrations)
